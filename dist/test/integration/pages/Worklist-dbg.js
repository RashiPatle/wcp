		...
		onTheHomePage : {
			...
			actions : Object.assign({
					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success : function (oTableItem) {
							...
							this.getContext().currentItem = {
								...
								name: oBindingContext.getProperty("BusinessPartnerRole")
							};
						}
					}));
				},
				...
				iSearchForValueWithActions : function (aActions) {
					return this.waitFor({
						...
						viewName : sViewName,
						actions: aActions,
						errorMessage : "Failed to find search field in Home view.'"
					});
				},
			...
			assertions: Object.assign({
				...
				theTableShouldHaveAllEntries : function () {
					...
					// retrieve all ZWCP_C_BP_INFO to be able to check for the total amount
					this.waitFor(this.createAWaitForAnEntitySet({
						entitySet: "ZWCP_C_BP_INFO",
				...
				iShouldSeeTheHomeViewsBusyIndicator : function () {
					return this.waitFor({
						id : "page",
						viewName : sViewName,
				...
				iShouldSeeTheHomeTableBusyIndicator : function () {
					return this.waitFor({
						id : "table",
						viewName : sViewName,
