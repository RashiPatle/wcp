sap.ui.define([
	...
	return BaseController.extend("com.westernacher.collaborationPortal.confirmation.controller.ConfirmationObjectPage", {
		...
		onPressBack: function () {
			...
			if (sPreviousHash !== undefined) {
				...
				oHashChanger.init();
				oHashChanger.setHash("FreightOrderConfirmation/" + _oMDModel.getProperty("/UserInfo/CurrentBusinessPartnerRole"));
			}
		},
		...
		onRouteMatched: function (oEvent) {
			...
			var oModel = this.oComponent._ConfH.setRoleModel(true, this.getView(), "CONFIRMATION", this.oComponent.defaultAnnotation);
			oModel.getMetaModel().loaded().then(function () {
				try {
					this.oComponent._AH.checkUserRoleMetaModel(oModel, this.oComponent._ConfH.sUserRole);
					this.oComponent._AH.checkUserRoleMetaModelForEntity(oModel, this.oComponent._ConfH.sUserRole, "ZWCP_C_Confirmation");
				} catch (er) {
					return;
				}
			}.bind(this));
			...
			oModel.metadataLoaded().then(function () {
				this.sObjectPath = oView.getModel().createKey("ZWCP_C_Confirmation", {
					FreightOrder: sKey
				});
		...
		onUpdateFOPress: function () {
			this.oComponent._ConfH.onUpdateFreightOrderPress(this.onUpdateFODatesObjectPageSuccess.bind(this), this.onUpdateFODatesObjectPageError
				.bind(this));
		},
